					...
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								...
								<a href="produitfemme.php">Film</a>
							</li>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<div class="search-product pos-relative bo4 of-hidden">
							<input class="s-text7 size6 p-l-23 p-r-50" type="text" name="search-product" placeholder="rechercher de la musique...">
...
$listeProduit=$Produit1P->produitmateriel();
...
?>
  ...
  <img src="images/icons/tuto/logo.jpg" alt="Flowers" style="width:390px;">
			</picture>
		</div>

		...
		<div class="container-menu-header">
			...
			<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							<li>
								<a href="tuto/product1.php">Livre</a>
							</li>
									
								

							<li>
								<a href="materiel.php">Cd</a>
							</li>
...
<?php foreach ($products as $product): ?>
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/jeux.jpg);">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<div class="search-product pos-relative bo4 of-hidden">
							<input class="s-text7 size6 p-l-23 p-r-50" type="text" name="search-product" placeholder="chercher un jeu video...">
                    ...
                    <a href="addwishlist.php?id=<?= $row['Referenceproduit'];?>"class="addPanier block2-btn-addwishlist hov-pointer trans-0-4">
                      ...
                      href="addwishlist.php?id=<?= $row['Referenceproduit'];?>"aria-hidden="true"></i>
								...
								<div class="block2-txt p-t-20">
									...
									<a href="views/product-detail.php?ref=<?= $row['Referenceproduit']; ?>" class="block2-name dis-block s-text3 p-b-5">
...
echo '<del class="block2-price m-text6 p-r-5 block2-labelsale">
	...
	<span class="block2-newprice m-text8 p-r-5">
										...
										<?PHP echo $row['prix']-($row['solde']/100)*$row['prix']; ?> €
